...
_MIGRATIONS: tuple[str, ...] = (
    ...
    """,
    # v23: drop the never-consumed "expert password" secret. It was captured,
    # encrypted, and decrypted into every CredentialBundle (CredentialKind.
    # EXPERT_PASSWORD), but no CPUSE/CDT code path ever read it back out —
    # dead plumbing from day one. Operator-directed removal, 2026-08-18.
    """
