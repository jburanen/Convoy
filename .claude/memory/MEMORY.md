...
- [Automatic state refresh](automatic-state-refresh.md) — hosts are re-queried after an add and after any package/install job (any outcome); UI polls a state-version token to notice
